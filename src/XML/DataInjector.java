...
/**
 * Provides functionality to inject data from an XML document into the application.
 */
public class DataInjector {
    ...
    public static String NodeAttributeValueGet(Node TheNode, String AttributeName) {
    ...
    public static Node[] NodeSelectManyGivenAttributeValue(Node[] Nodes, String AttributeName, String Value) {
        Node[] selectedNodes = null;
